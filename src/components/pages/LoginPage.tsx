  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        {!isConfigured && (
          <div className="bg-slate-900 border border-amber-800/60 rounded-2xl p-5 shadow-xl shadow-black/40 space-y-2">
            <div className="flex items-start gap-3">
              <AlertCircle className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" />
              <div>
                <span className="text-xs font-semibold text-amber-200 block">Supabase não configurado</span>
                <p className="text-[11px] text-slate-400 mt-1 leading-relaxed">
                  As variáveis de ambiente <code className="text-amber-300 font-mono text-[10px]">VITE_SUPABASE_URL</code> e <code className="text-amber-300 font-mono text-[10px]">VITE_SUPABASE_ANON_KEY</code> não foram detectadas no build. Configure-as no arquivo <code className="text-slate-300 font-mono text-[10px]">.env</code> ou nos Secrets do GitHub Actions para autenticar.
                </p>
              </div>
            </div>
          </div>
